...
public class DashboardOverviewResponse {
  ...
  public long getBreachedOpenCount() {
    return breachedOpenCount;
  }

  public void setBreachedOpenCount(long breachedOpenCount) {
    this.breachedOpenCount = breachedOpenCount;
  }
  ...
  public void setAvgResolveHours(double avgResolveHours) {
    this.avgResolveHours = avgResolveHours;
  }

  public long getTodayNewTickets() {
    return todayNewTickets;
  }

  public void setTodayNewTickets(long todayNewTickets) {
    this.todayNewTickets = todayNewTickets;
  }

  public long getMyAssignedOpen() {
    return myAssignedOpen;
  }

  public void setMyAssignedOpen(long myAssignedOpen) {
    this.myAssignedOpen = myAssignedOpen;
  }
}
