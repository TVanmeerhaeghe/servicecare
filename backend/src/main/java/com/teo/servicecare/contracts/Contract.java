...
public class Contract {
  ...
  public enum SupportDays { MON_FRI, SEVEN_DAYS }
  public enum MeasureWindow { BUSINESS_HOURS, CALENDAR }
  ...
  @Column(
      name = "support_days",
      nullable = false,
      columnDefinition = "enum('MON_FRI','SEVEN_DAYS')"
  )
  ...
  @Column(
      name = "measure_window",
      nullable = false,
      columnDefinition = "enum('BUSINESS_HOURS','CALENDAR')"
  )
  ...
  @Column(
      name = "status",
      nullable = false,
      columnDefinition = "enum('ACTIVE','INACTIVE','EXPIRED')"
  )
  ...
  public SupportDays getSupportDays() { return supportDays; }
  public void setSupportDays(SupportDays supportDays) { this.supportDays = supportDays; }
  ...
  public MeasureWindow getMeasureWindow() { return measureWindow; }
  public void setMeasureWindow(MeasureWindow measureWindow) { this.measureWindow = measureWindow; }
  public boolean isPauseOnWaiting() { return pauseOnWaiting; }
