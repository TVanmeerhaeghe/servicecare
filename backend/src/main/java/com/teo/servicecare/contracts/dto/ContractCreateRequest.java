...
public class ContractCreateRequest {
  ...
  public Contract.SupportDays getSupportDays() {
    return supportDays;
  }

  public void setSupportDays(Contract.SupportDays supportDays) {
  ...
  public Contract.MeasureWindow getMeasureWindow() {
    return measureWindow;
  }

  public void setMeasureWindow(Contract.MeasureWindow measureWindow) {
    this.measureWindow = measureWindow;
  }

  public Boolean getPauseOnWaiting() {
  ...
  public Integer getRespCritHours() {
    return respCritHours;
  }

  public void setRespCritHours(Integer respCritHours) {
    this.respCritHours = respCritHours;
  }

  public Integer getRespHighHours() {
    return respHighHours;
  }

  public void setRespHighHours(Integer respHighHours) {
    this.respHighHours = respHighHours;
  }

  public Integer getRespMediumHours() {
    return respMediumHours;
  }

  public void setRespMediumHours(Integer respMediumHours) {
    this.respMediumHours = respMediumHours;
  }

  public Integer getRespLowHours() {
    return respLowHours;
  }

  public void setRespLowHours(Integer respLowHours) {
    this.respLowHours = respLowHours;
  }

  public Integer getResoCritHours() {
    return resoCritHours;
  }

  public void setResoCritHours(Integer resoCritHours) {
    this.resoCritHours = resoCritHours;
  }

  public Integer getResoHighHours() {
    return resoHighHours;
  }

  public void setResoHighHours(Integer resoHighHours) {
    this.resoHighHours = resoHighHours;
  }

  public Integer getResoMediumHours() {
    return resoMediumHours;
  }

  public void setResoMediumHours(Integer resoMediumHours) {
    this.resoMediumHours = resoMediumHours;
  }

  public Integer getResoLowHours() {
    return resoLowHours;
  }

  public void setResoLowHours(Integer resoLowHours) {
    this.resoLowHours = resoLowHours;
  }

  public Integer getIncludedHoursMonth() {
    return includedHoursMonth;
  }

  public void setIncludedHoursMonth(Integer includedHoursMonth) {
    this.includedHoursMonth = includedHoursMonth;
  }

  public Integer getMaxTicketsMonth() {
    return maxTicketsMonth;
  }

  public void setMaxTicketsMonth(Integer maxTicketsMonth) {
